...
class StudentVC: UIViewController {
    ...
    private let welcomelbl:UILabel = {
        let labl = UILabel()
        labl.text = ""
        labl.font = .boldSystemFont(ofSize: 22)
        labl.textAlignment = .center
        labl.textColor = .white
       
        labl.backgroundColor = #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1)
    ...
    private let classLabelName:UILabel = {
        ...
        labl.font = .systemFont(ofSize: 20)
        labl.textAlignment = .center
    ...
    private let allNotice:UIButton = {
        ...
        button.setImage(UIImage(named: "noticeicon"),for: .normal)
        return button
    }()
    ...
    private let icontext:UILabel = {
        ...
        labl.font = .boldSystemFont(ofSize: 25)
        labl.textAlignment = .center
        labl.textColor = .black
        labl.layer.masksToBounds = true
        labl.layer.cornerRadius = 20
    ...
    private let logout : UIButton = {
        ...
        con.setTitleColor(.white, for: .normal)
        con.layer.cornerRadius = 25
        con.backgroundColor = #colorLiteral(red: 0.8078431487, green: 0.02745098062, blue: 0.3333333433, alpha: 1)
        return con
    } ()
    ...
    override func viewDidLoad() {
        ...
        backgroundImage.image = UIImage(named: "bg7.jpg")
    ...
    override func viewDidLayoutSubviews() {
        ...
        welcomelbl.frame = CGRect(x: 20, y: 80, width: view.width - 40, height: 60)
        classLabelName.frame = CGRect(x: 70, y: welcomelbl.bottom + 5, width: 120, height: 40)
        classLabel.frame = CGRect(x: classLabelName.right + 10, y: welcomelbl.bottom + 5, width: 100, height: 40)
        divLabelName.frame = CGRect(x: 70, y: classLabelName.bottom + 5, width: 120, height: 40)
        divLabel.frame = CGRect(x: divLabelName.right + 10, y: classLabelName.bottom + 5, width: 100, height: 40)
        semLableName.frame = CGRect(x: 70, y: divLabelName.bottom + 5, width: 120, height: 40)
        ...
        icontext.frame = CGRect(x: 60, y: allNotice.bottom + 2, width: view.width - 120 , height: 20)
        changepwd.frame = CGRect(x: 100, y: icontext.bottom + 20, width: view.width / 2, height: 50)
        logout.frame = CGRect(x: 100, y: changepwd.bottom + 10, width: view.width / 2, height: 50)
    }
